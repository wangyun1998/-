        ...
        request.get(
            ...
            function (err: any, _: any, _body: any) {
                if (err) {
                    ...
                    const index = ((Math.random() * (0 - (resJsonData.length - 1) + 1) + (resJsonData.length - 1)) | 0)
                    console.log(index)
...
const idiomSolitaire = function (params: any) {
    return new Promise((resolve, _reject) => {
        let url = `https://apis.tianapi.com/chengyujielong/index?key=e913fffc9e6d4b29437a820714f3c3e1&word=${params.isStart ? params.word : "Start"}&userid=98105401289c18d858c169578ecf0125`;
